...
Rails.application.configure do
  ...
  # config/master.key, or an environment key prefix when credentials are setup.
  ...
  # avoids logging too much information to avoid inadvertent exposure of personally
  # identifiable information (PII). If you want to log everything, set it to "debug".
